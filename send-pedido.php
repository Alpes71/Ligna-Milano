...
$acuse = [
 'es' => ["Comprobante de formulario de pedido",
   ...
   "Sobre el envío: una vez confirmemos tu pago y hayas aprobado el diseño, tu pedido pasa a producción y se envía en un plazo de 72 horas.",
   "Sí", "No",
 ...
 'ca' => ["Comprovant de formulari de comanda",
   ...
   "Sobre l'enviament: un cop confirmem el teu pagament i hagis aprovat el disseny, la teva comanda passa a producció i s'envia en un termini de 72 hores.",
   "Sí", "No",
 ...
 'va' => ["Comprovant de formulari de comanda",
   ...
   ["Nom","Adreça","Ciutat","Codi postal","Província","País","Correu electrònic","Mòbil","Mètode de pagament","Referència de producte","Comprovant adjunt"],
   "Sobre l'enviament: una vegada confirmem el teu pagament i hages aprovat el disseny, la teua comanda passa a producció i s'envia en un termini de 72 hores.",
   "Sí", "No",
   "Gràcies per confiar en Ligna Milano.",
   "Horari d'atenció: de dilluns a divendres de 9 a 18 h · Dissabtes, diumenges i festius tancat."],
 'eu' => ["Eskaera formularioaren frogagiria",
   ...
   "Bidalketari buruz: zure ordainketa berretsi eta diseinua onartu ondoren, zure eskaera ekoizpenera pasatzen da eta 72 orduko epean bidaltzen da.",
   "Bai", "Ez",
 ...
 'gl' => ["Xustificante de formulario de pedido",
   ...
   "Sobre o envío: unha vez confirmemos o teu pagamento e aprobaras o deseño, o teu pedido pasa a produción e envíase nun prazo de 72 horas.",
   "Si", "Non",
 ...
 'en' => ["Order form receipt",
   ...
   "About shipping: once we confirm your payment and you approve the design, your order goes into production and ships within 72 hours.",
   "Yes", "No",
 ...
 'fr' => ["Justificatif de formulaire de commande",
   ...
   "À propos de l'expédition : une fois votre paiement confirmé et le design approuvé, votre commande passe en production et est expédiée sous 72 heures.",
   "Oui", "Non",
 ...
 'de' => ["Bestätigung des Bestellformulars",
   ...
   "Zum Versand: Sobald wir Ihre Zahlung bestätigt haben und Sie das Design genehmigt haben, geht Ihre Bestellung in Produktion und wird innerhalb von 72 Stunden versandt.",
   "Ja", "Nein",
